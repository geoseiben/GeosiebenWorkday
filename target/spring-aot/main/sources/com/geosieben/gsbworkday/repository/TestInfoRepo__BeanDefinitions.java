...
/**
 * Bean definitions for {@link TestInfoRepo}.
 */
@Generated
public class TestInfoRepo__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'testInfoRepo'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getTestInfoRepoInstanceSupplier() {
    return BeanInstanceSupplier.<JpaRepositoryFactoryBean>forConstructor(Class.class)
            .withGenerator((registeredBean, args) -> new JpaRepositoryFactoryBean(args.get(0)));
  }

  /**
   * Get the bean definition for 'testInfoRepo'.
   */
  public static BeanDefinition getTestInfoRepoBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, TestInfoRepo.class, TestInfo.class, String.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.geosieben.gsbworkday.repository.TestInfoRepo");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.TestInfoRepo.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.geosieben.gsbworkday.repository.TestInfoRepoImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getTestInfoRepoInstanceSupplier();
