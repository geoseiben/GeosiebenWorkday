 ...
 */
@Generated
public class GsbWorkDayApplication__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new GsbWorkDayApplication__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new GsbWorkDayApplication__BeanFactoryRegistrations().registerAliases(beanFactory);
  }
  ...
  private void addImportAwareBeanPostProcessors(DefaultListableBeanFactory beanFactory) {
    ...
    mappings.put("org.springframework.security.config.annotation.method.configuration.PrePostMethodSecurityConfiguration", "com.geosieben.gsbworkday.config.SecurityConfig");
    mappings.put("org.springframework.security.config.annotation.web.configuration.WebSecurityConfiguration", "com.geosieben.gsbworkday.config.SecurityConfig");
